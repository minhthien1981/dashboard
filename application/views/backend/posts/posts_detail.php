	...
	<div class="row">
		...
		<div class="col-md-12 col-xs-12">
			<div class="option-content">
				...
				<label class="title-field mgb20">Rate: <?= $posts->p_rate;?>%</label>
				...
				<a type="button" target="_blank" href="<?php echo base_url().ADMIN.'posts/export_excel/'.$posts->p_id; ?>" name="exportExcel" id="exportExcel" class="btn btn-success">Xuất Excel</a>
			</div>
		</div>
	</div>
