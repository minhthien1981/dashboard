...
$config['licenseName'] = 'ThangTKT';
$config['licenseKey']  = '*X?Z-*1**-Q**A-*R**-*V**-9*Q*-3**B';
...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'videos',
    'maxSize'           => 0,
    'allowedExtensions' => 'mov,mp3,mp4,avi',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
/*================================ Access Control =====================================*/
...
$config['ImageWatermark'] = [
    'imagePath' => '/uploads/images/watermark.png', // Also use a custom image.
    'position' => [
        'right'  => 0,
        'bottom' => 0
    ]
